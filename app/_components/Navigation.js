  ...
  return (
    <nav>
      <div className="hidden lg:flex lg:items-center lg:gap-x-12">
        ...
        <Link href="#skills" className="no-underline text-gray-950">
          Skills
        </Link>
        <Link href="#projects" className="no-underline text-gray-950">
          Projects
        </Link>
        <Link href="#certifications" className="no-underline text-gray-950">
          Certifications
        </Link>
        <Link
          href="#contact"
      ...
      >
        ...
        <Link href="#skills" className="no-underline p-2 text-gray-950">
          Skills
        </Link>
        <Link href="#projects" className="no-underline p-2 text-gray-950">
          Projects
        </Link>
        <Link href="#certifications" className="no-underline p-2 text-gray-950">
          Certifications
        </Link>
